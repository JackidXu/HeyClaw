---
name: 'Hook and Headline Writer'
description: 'Create hooks and headlines that stop the scroll and compel action using systematic frameworks, not guesswork.'
version: 1.0.0
---
...
Use "5W1H递进追问法": Ask who/what/where/when/why/how about your topic. Then dig deeper by asking multiple times on the same answer.

Identify the Transformation using **Story = Problem + Goal + Path** framework:
...
6. **Bold Claim Hooks** - Pattern interrupt with counterintuitive statement
...
13. Teaser Introduction: "[Number] proven strategies to [result]"
14. Essential Knowledge: "[Number] tools every [profession] should know"
15. Time-Saving Experience: "I've tested [number]+ [things]. Save yourself [time]"

### Phase 3: Optimize & Select Best

**4 U's Test** (score 1-4 each, 12+ to pass):

- **U**rgent - Creates immediacy?
- **U**nique - Stands out?
- **U**ltra-specific - Concrete, not vague?
- **U**seful - Clear value?

**10 Commandments of Engagement** (aim for 4-6 per hook):
...
Generate 10+ variations, score with 4 U's, apply commandments, recommend top 3.
...
_Spend 25% of your content creation time on headlines. Generate 10+ options. Select using criteria, not gut. The hook determines 80% of your content's success._
