...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    artifactBrowserAnnotationPromptTitle: '请根据浏览器截图中的标注元素处理以下注释：',
  ...
  en: {
    ...
    artifactBrowserAnnotationPromptTitle: 'Please handle the note for the marked element in the browser screenshot:',
