...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    copied: '已复制',
    copyrightHolder: 'HeyClaw 版权所有',
    aboutThirdPartyLicenses: '第三方开源组件声明',
    ...
    shortcutDescNewChat: '开始一个新的 HeyClaw 任务',
    shortcutDescFocusPrompt: '跳回 HeyClaw 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 HeyClaw 任务视图',
    ...
    artifactPreviewCardLobsterBrowser: 'HeyClaw浏览器',
    artifactPreviewCardOpenInLobsterBrowser: '在HeyClaw浏览器中打开',
    ...
    coworkWorkingDirectoryHint: 'HeyClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 HeyClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 HeyClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'HeyClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 HeyClaw 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 HeyClaw 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 HeyClaw 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 HeyClaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'HeyClaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'HeyClaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    kits: '召唤专家',
    newFeatureBadge: 'NEW',
    kitSearchPlaceholder: '搜索专家，如“选题”、“封面设计”、“追热点”',
    kitInstall: '召唤',
    kitInstalling: '召唤中...',
    kitUninstall: '解除召唤',
    kitUninstallConfirm: '确定要送回专家“{name}”吗？',
    kitUninstalling: '送回中...',
    kitInstalled: '召回',
    kitReinstallRequiredBadge: '需重新召唤',
    kitReinstallRequiredDetail: '已召唤版本 v{installedVersion}，当前版本 v{currentVersion}。请先解除召唤后重新召唤以使用新版本。',
    kitLoading: '加载中...',
    kitEmpty: '暂无专家',
    kitBack: '返回',
    kitTryAsking: '试试这样问...',
    kitSkills: '技能',
    kitDescription: '召唤 AI 专家加入你的团队，每个人都有自己的绝活',
    kitMarketplace: '全部专家',
    kitIPMarketing: 'IP营销',
    kitImageProduction: '图片制作',
    kitSkillCount: '{count} 个技能',
    kitOfficial: '官方',
    manageKits: '管理专家',
    searchKits: '搜索专家',
    clearKit: '清除专家',
    noKitsInstalled: '暂无已召唤专家',
    kitInstallGuideDescription: '基于工作场景的标准能力包',
    kitGoInstall: '去召唤',
    kitSearchNoResults: '未找到匹配专家',
    kitInstallRequired: '需要召唤',
    kitInstallRequiredDesc: '该专家尚未召唤，是否立即召唤并体验？',
    kitDirectChatDisabledTooltip: '请先召唤该专家以启用直接对话',
    ...
    browserWebAccessDescription: '使用 HeyClaw 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'HeyClaw 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 HeyClaw 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'HeyClaw 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 HeyClaw 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 HeyClaw 可以打开此域名',
    ...
    usageAnalyticsEnabled: '帮助改进 HeyClaw',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'HeyClaw服务协议',
    privacyDialogDesc: '在使用HeyClaw之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'HeyClaw服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用HeyClaw',
  ...
  en: {
    ...
    copied: 'Copied',
    copyrightHolder: 'HeyClaw. All rights reserved.',
    ...
    shortcutScopeHint: 'Shortcuts only run while the HeyClaw window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open HeyClaw',
    ...
    shortcutDescNewChat: 'Start a new HeyClaw task',
    shortcutDescFocusPrompt: 'Return to HeyClaw and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the HeyClaw task view',
    ...
    artifactPreviewCardLobsterBrowser: 'HeyClaw Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in HeyClaw Browser',
    ...
    // HeyClaw
    cowork: 'HeyClaw',
    coworkSettings: 'HeyClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'HeyClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for HeyClaw...',
    coworkSystemPromptHint: "Optional system prompt to customize HeyClaw's behavior",
    ...
    coworkModelSettingsHint:
      'HeyClaw uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up HeyClaw data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import HeyClaw data',
    ...
    openClawDataMigrationConfirmTitle: 'Import HeyClaw data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save HeyClaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'HeyClaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'HeyClaw needs your input',
    ...
    skillUpgradeSuccess: 'Update successful',
    ...
    kits: 'Summon Experts',
    newFeatureBadge: 'NEW',
    kitSearchPlaceholder: 'Search experts, e.g. "writing", "cover design", "trends"',
    kitInstall: 'Summon',
    kitInstalling: 'Summoning...',
    kitUninstall: 'Dismiss',
    kitUninstallConfirm: 'Are you sure you want to dismiss the expert "{name}"?',
    kitUninstalling: 'Dismissing...',
    kitInstalled: 'Summoned',
    kitReinstallRequiredBadge: 'Re-summon needed',
    kitReinstallRequiredDetail:
      'Summoned version v{installedVersion}, current version v{currentVersion}. Dismiss and summon again to use the new version.',
    kitLoading: 'Loading...',
    kitEmpty: 'No experts available',
    kitBack: 'Back',
    kitTryAsking: 'Try asking...',
    kitSkills: 'Skills',
    kitDescription: 'Summon AI experts to join your team, each with their own unique skills',
    kitMarketplace: 'All Experts',
    kitIPMarketing: 'IP Marketing',
    kitImageProduction: 'Image Production',
    kitSkillCount: '{count} skills',
    kitOfficial: 'Official',
    manageKits: 'Manage Experts',
    searchKits: 'Search experts',
    clearKit: 'Clear Expert',
    noKitsInstalled: 'No expert summoned yet',
    kitInstallGuideDescription: 'Standard capability packs for work scenarios',
    kitGoInstall: 'Go Summon',
    kitSearchNoResults: 'No matching experts found',
    kitInstallRequired: 'Summon Required',
    kitInstallRequiredDesc: 'This expert has not been summoned yet. Would you like to summon them now?',
    kitDirectChatDisabledTooltip: 'Please summon the expert first to enable direct chat',
    ...
    browserWebAccessDescription: 'Use the HeyClaw separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'HeyClaw starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for HeyClaw, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'HeyClaw will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means HeyClaw will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means HeyClaw can open this domain',
    ...
    usageAnalyticsEnabled: 'Help improve HeyClaw',
    ...
    // Privacy dialog
    privacyDialogTitle: 'HeyClaw Terms of Service',
    privacyDialogDesc:
      'Before using HeyClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'HeyClaw Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to HeyClaw',
