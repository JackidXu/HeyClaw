...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    // Tray menu
    trayShowWindow: '打开 HeyClaw',
    trayNewTask: '新建任务',
    trayViewCompletedTask: '查看完成的任务',
    trayCompletedTaskTooltip: 'HeyClaw - {count} 个任务已完成',
    traySettings: '设置',
    trayQuit: '退出',
    ...
    dataMigrationBackupDialogTitle: '备份 HeyClaw 数据',
    dataMigrationRestoreDialogTitle: '导入 HeyClaw 数据备份',
    dataMigrationBackupArchiveFilter: 'HeyClaw 备份包',
    dataMigrationAllFilesFilter: '所有文件',
    dataMigrationBackupBlockedByActiveWorkloads:
      '当前有正在运行的 Agent 或定时任务，请停止或等待任务完成后再备份。',
    dataMigrationRestoreProgressTitle: '正在导入 HeyClaw 数据',
  ...
  en: {
    // Tray menu
    trayShowWindow: 'Open HeyClaw',
    trayNewTask: 'New Task',
    trayViewCompletedTask: 'View Completed Task',
    trayCompletedTaskTooltip: 'HeyClaw - {count} completed task(s)',
    ...
    coworkGatewaySessionSyncTimeout: 'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add HeyClaw to your antivirus allowlist.',
    ...
    // Data migration dialogs
    dataMigrationBackupDialogTitle: 'Back Up HeyClaw Data',
    dataMigrationRestoreDialogTitle: 'Import HeyClaw Data Backup',
    dataMigrationBackupArchiveFilter: 'HeyClaw Backup',
    ...
    dataMigrationRestoreProgressTitle: 'Importing HeyClaw data',
    dataMigrationRestoreProgressDesc:
      'Restoring the backup and validating data. HeyClaw will restart automatically when finished.',
